...
app.get("/foodinfo/:id",function(req,res){
  const {id} = req.params
  const user = req.user.username
...
app.get("/modify-food/:id",function(req,res){
  const {id} = req.params
  const user = req.user.username
...
app.post("/modify-food/:id",function(req,res){
...
app.get("/activity/:date",function(req,res){
  const {date} = req.params
...
app.get("/modify-activity/:id",function(req,res){
  const {id} = req.params
  const user = req.user.username
...
app.post("/modify-activity/:id",function(req,res){
